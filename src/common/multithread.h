...
void do_multithread(void (*f)(int th, int start,int end), int n);
...
#define __multithread_2__(func)  \
		void _do_##func (int, int); void func(int N) {do_multithread(_do_##func, N);}	\
		void _do_##func

#define __multithread_3__(func)  \
		void _do_##func (int, int, int); void func(int N) {do_multithread(_do_##func, N);}	\
		void _do_##func
